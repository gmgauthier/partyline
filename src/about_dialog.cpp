...
AboutDialog::AboutDialog(Gtk::Window& parent)
    : Gtk::Dialog("About Partyline", parent, true)
{
  set_resizable(false);
  ...
  title->set_markup("<b>Partyline " VERSION "</b>");
  box->pack_start(*title, Gtk::PACK_SHRINK);

  auto* line = Gtk::manage(new Gtk::Label(
      "Partyline — an mIRC-shaped IRC client for The Lunduke Computer Operating System."));
