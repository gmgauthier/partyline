...
**M6 / v0.1.0.** Packaged. Keys, palettes (white / eggshell / black / navy / olive), lag, `/msg` `/quote` `/nick`.
...
| **M6 — Package** | `debian/`, `scripts/release.sh` → `.deb`, tarball, AppImage. Tag `v0.1.0`. **In tree.** |
